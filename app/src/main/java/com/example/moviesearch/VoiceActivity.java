...
import com.example.moviesearch.databinding.ActivityVoiceBinding;
...
public class VoiceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Voice_State = binding.VoiceState;
        //펄미션 체크
        ...
        mRe = SpeechRecognizer.createSpeechRecognizer(this);
...
//                result = matches.get(i);
                Voice_State.setText(matches.get(i));
